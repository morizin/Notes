...
\begin{figure}[H]
    \centering
    \hbox{ % Creates a box around the content
        \begin{minipage}{0.9\textwidth} % Adjust width as needed
            \begin{minipage}{0.48\textwidth} % Left side for the table
                \centering
                \begin{tabular}{|c|c|c|c|}
                    ...
                    \hline
                \end{tabular}
                \captionof{table}{Time Functions}
            \end{minipage}
            \hfill
            \begin{minipage}{0.48\textwidth} % Right side for the image
                \centering
                \includegraphics[width=\textwidth]{../images/1_6mpaXFsrRPFXSKXK5Qgm8w.png}
                \captionof{figure}{Time Functions}
            \end{minipage}
        \end{minipage}
    }
\end{figure}
...
\begin{figure}[H]
    ...
    \hbox{
        \begin{minipage}{0.9\textwidth}
            ...
            \begin{minipage}{0.5\textwidth}
                \centering
                \includegraphics[width=1\textwidth]{../images/1_6mpaXFsrRPFXSKXK5Qgm8w.png}
                \captionof{figure}{Time Functions}
            \end{minipage}
        \end{minipage}
    }
